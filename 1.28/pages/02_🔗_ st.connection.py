...
st.write("`st.connection` is now fully supported in Streamlit. Upgrade your legacy `st.experimental_connection` scripts today to enjoy the benefits of this newly released version.")
