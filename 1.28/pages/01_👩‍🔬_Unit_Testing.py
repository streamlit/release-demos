...
st.write("Our new unit testing API makes it easy to automate your app testing. Learn more in the docs [TODO: add link].")
...
st.markdown(
    f'<img src="data:image/gif;base64,{data_url}" width=1200 alt="demo gif">',
    unsafe_allow_html=True,
)
# st.image(gif)
