...
st.write("This spinner has received UI improvements – it is now smaller and overlayed on top of existing UI elements, preventing jumpiness and visual glitches.", icon="ℹ️")
